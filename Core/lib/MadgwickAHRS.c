...
void MadgwickAHRS_update(MadgwickAHRS *obj, float gx, float gy, float gz, float ax, float ay, float az)
{
    float recipNorm;
    float s0, s1, s2, s3;
    ...
    if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f)))
    {
        ...
        s1 = _4q1 * q3q3 - _2q3 * ax + 4.0f * q0q0 * obj->q1 - _2q0 * ay - _4q1 + _8q1 * q1q1 + _8q1 * q2q2 + _4q1 * az;
        s2 = 4.0f * q0q0 * obj->q2 + _2q0 * ax + _4q2 * q3q3 - _2q3 * ay - _4q2 + _8q2 * q1q1 + _8q2 * q2q2 + _4q2 * az;
        s3 = 4.0f * q1q1 * obj->q3 - _2q1 * ax + 4.0f * q2q2 * obj->q3 - _2q2 * ay;
    ...
    recipNorm = invSqrt(obj->q0 * obj->q0 + obj->q1 * obj->q1 + obj->q2 * obj->q2 + obj->q3 * obj->q3);
    obj->q0 *= recipNorm;
    obj->q1 *= recipNorm;
    obj->q2 *= recipNorm;
    obj->q3 *= recipNorm;
    ...
    // Euler
    obj->euler[2] = atan2(2 * (obj->q0 * obj->q1 + obj->q2 * obj->q3), 1 - 2 * (obj->q1 * obj->q1 + obj->q2 * obj->q2));
    obj->euler[1] = asin(2 * (obj->q0 * obj->q2 - obj->q3 * obj->q1));
    obj->euler[0] = atan2(2 * (obj->q0 * obj->q3 + obj->q1 * obj->q2), 1 - 2 * (obj->q2 * obj->q2 + obj->q3 * obj->q3));
}
